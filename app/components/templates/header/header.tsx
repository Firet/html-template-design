  ...
  return (
    <header className="header-container">
      ...
      <section className="user-section">
        <div className="user-item">USD <img src="./arrow-down.svg" className="arrow" width={11} alt="arrow down" /></div>
        <div className="user-item"> <img src="./cart.svg" className="cart" width={11} alt="cart" />CART(5)</div>
        <div className="user-item"><Button priority="accent">SIGN IN</Button></div>
      </section>
    </header>
  );
}
